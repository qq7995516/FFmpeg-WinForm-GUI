namespace ffmpeg视频处理
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // contextMenuStrip1
            // 
            contextMenuStrip1.Items.AddRange(new ToolStripItem[] { 合并视频ToolStripMenuItem, 合并音频ToolStripMenuItem, 合并音视频ToolStripMenuItem, 删除勾选项ToolStripMenuItem, 清空ToolStripMenuItem, 添加文件ToolStripMenuItem });
            contextMenuStrip1.Name = "contextMenuStrip1";
            contextMenuStrip1.Size = new Size(144, 148);
            // 
